    ...
    return Scaffold(
       appBar: AppBar(
        ...
        child: Container(child: Column(children: [
          ...
          Row(children: [
            ChooseCard(title: 'DJI Pro', image: 'images/dji_pro.png', color: controller.card1Color, cardFunction: (){controller.changeBodyFunction(1);}),
            const SizedBox(width: 10,),
            ChooseCard(title: 'GHS Extreme', image: 'images/ghs_extreme.png', color: controller.card2Color, cardFunction: (){controller.changeBodyFunction(2);}),
          ],),
          const SizedBox(height: 10,),
          Row(children: [
            ChooseCard(title: 'RedPro KL', image: 'images/redpro_kl.png', color: controller.card3Color, cardFunction: (){controller.changeBodyFunction(3);}),
            const SizedBox(width: 10,),
            ChooseCard(title: 'BigBug 768', image: 'images/bigbug_768.png', color: controller.card4Color, cardFunction: (){controller.changeBodyFunction(4);}),
          ],),
          const SizedBox(height: 150,),
          ButtonPattern(onPressed: (){Navigator.push(context, MaterialPageRoute(builder: (context) => ChooseDroneAcessoryPage()),);}, buttonText: 'Próximo'),
        ],),
        )
      )
    );
