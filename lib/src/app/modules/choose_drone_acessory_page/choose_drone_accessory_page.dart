    ...
    return Scaffold(
       appBar: AppBar(
        ...
        child: Container(child: Column(children: [
          ...
          Row(children: [
            ChooseCard(title: 'LED Gamer', image: 'images/led_gamer.png', color: controller.card1Color, cardFunction: (){controller.changeBodyFunction(1);}),
            const SizedBox(width: 10,),
            ChooseCard(title: 'Adesivos', image: 'images/adesivos.png', color: controller.card2Color, cardFunction: (){controller.changeBodyFunction(2);}),
          ],),
          const SizedBox(height: 10,),
          Row(children: [
            ChooseCard(title: 'Chaveiros', image: 'images/chaveiro.png', color: controller.card3Color, cardFunction: (){controller.changeBodyFunction(3);}),
            const SizedBox(width: 10,),
            ChooseCard(title: 'Pintura Herói', image: 'images/heroi.png', color: controller.card4Color, cardFunction: (){controller.changeBodyFunction(4);}),
          ],),
